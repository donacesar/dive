...
$avatar = $info['avatar'];
if ($avatar === '') {
    $avatar = 'img/demo/avatars/no_image.png';
}
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?=$avatar; ?>" alt="" class="img-responsive" width="200">
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="example-fileinput">Выберите аватар</label>
                                    <input type="file" id="example-fileinput" class="form-control-file" name="img" required>
